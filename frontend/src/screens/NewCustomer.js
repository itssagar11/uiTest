    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div className='form-container'>
          <input type='number' name='accountNo' placeholder='Enter Account No' value={formData.accountNo} onChange={handleChange} required />
      ...
      {/* {success && <div className='success'>{success}</div>} */}
        <div className='success'> Customer created successfully</div>
      </form>
